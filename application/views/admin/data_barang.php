<div class="container-fluid">
	<button class="btn btn-sm btn-primary mb-3" style="margin-bottom: 10px; margin-top: 10px; color: black;" data-toggle="modal" data-target="#tambah_barang"><i class="fas fa-plus fa-sm"></i><a href="<?php echo base_url('admin/data_barang/tambah') ?>">Tambah Barang</a></button>
