      ...
      <div class="shop_top">
		<div class="container">
			<div class="row shop_box-top">
				...
				<div class="col-md-3 shop_box"><a href="single.html">
					<img src="<?php echo base_url('assets/images/makanan.jpg') ?>" class="img-responsive" alt=""/>
					<div class="shop_desc">
				...
				<div class="col-md-3 shop_box"><a href="single.html">
					<img src="<?php echo base_url('assets/images/minuman.jpg') ?>" class="img-responsive" alt=""/>
					<div class="shop_desc">
				...
				<div class="col-md-3 shop_box"><a href="single.html">
					<img src="<?php echo base_url('assets/images/pakaian.jpg') ?>" class="img-responsive" alt=""/>
					<div class="shop_desc">
